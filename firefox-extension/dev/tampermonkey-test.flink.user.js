...
(function() {
    ...
    for (var i = 0; i < flinkElements.length; i++) {
        ...
        if (flinkElement.hasAttribute('id'))
        {
            ...
            flinkElement.innerHTML = flinkElement.innerHTML + "<a href='#" + flinkElement.id + "' class='flink-anchor' title='Click or share this link to autoscroll to this position.'><span class='flink-anchor-icon'>&nbsp;</span></a>";
